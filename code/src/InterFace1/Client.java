...
public class Client {
	 ...
	 static InterFace obj,obj1,obj2;
	...
	public static void main(String args[]) throws Exception{
        ...
        URL inseURL = new URL("http://localhost:8082/inse?wsdl");
 		...
 		obj = compService.getPort(InterFace.class);
 		obj1 = soenService.getPort(InterFace.class);
 		obj2 = inseService.getPort(InterFace.class);
		...
		String path = null;
			...
			try {
				...
				{
					path="asmt1_16";
					File f2 = new File("G:/DEEP/Ass2/src/errorclient.txt");
		         ...
		         f = new File("G:/DEEP/Ass2/src/"+path+"/"+ID+".txt");
                			...
                			case 1:
                				...
                				if((studentID1.substring(0, 4)).equals("soen") || (studentID1.substring(0, 4)).equals("inse"))
                				{
                					...
                					try {
                        				...
                        				File f01 = new File("G:/DEEP/Ass2/src/comp/Server1.txt");
            ...
            {  
                ...
                case 'a':  
            		...
            		case 4:
        				...
        				File f0 = new File("G:/DEEP/Ass2/src/comp/Server2.txt");
        				BufferedWriter output0 =new BufferedWriter(new FileWriter(f0,true));
        				Date date1 = new Date();
        				output0.write(sdf.format(date1)+"  , "+ID+" , addcourse , ");
        				if(g.equals("course "+courseID+" added in "+semester+" term"))
        			...
        			case 1:
        				...
        				try {
    						...
    						File f01 = new File("G:/DEEP/Ass2/src/soen/Server2.txt");
            				BufferedWriter output01 =new BufferedWriter(new FileWriter(f01,true));
            				Date date11 = new Date();
            				output01.write(sdf.format(date11)+"  , "+ID+" , enrolcourse , sucessfull\\n\\n");
            				output01.close();
        			...
        			case 1:
        				...
        				try {
    						...
    						if(ou.equals(studentID1+"is successfully enrolled in "+ courseID))
    						{
    							...
    							File f01 = new File("G:/DEEP/Ass2/src/inse/Server3.txt");
                				BufferedWriter output01 =new BufferedWriter(new FileWriter(f01,true));
                				Date date11 = new Date();
                				output01.write(sdf.format(date11)+"  , "+ID+" , enrolcourse , sucessfull\\n\\n");
                				output01.close();
