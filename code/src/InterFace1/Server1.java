...
import InterFace1.ImpInterFace;
  ...
  class server1methods{
	...
	public static int count[]=new int[] {0,0,0};
		public  void default_values1()
		{
			...
			compwinter.add( "comp5555");
			
			compsummer.add( "comp3333");
			compsummer.add( "comp4444");
			...
			compwintersubject1.put("comp5555", 1);
			compsummersubject1.put("comp3333", 2);
			compsummersubject1.put("comp4444", 1);
			...
			compwintersubject.put("comp5555", 1);
			compsummersubject.put("comp3333", 2);
			compsummersubject.put("comp4444", 1);

			compfallstudent.put("comps11111", "comp1111");
			compwinterstudent.put("comps22221", "comp2222");
			compwinterstudent.put("comps11111", "comp2222");
	...
	//------------------ - - - - - - - - - - - - - - - - - - - - - ------------------------------------------	
		...
		public static synchronized String addCourse1(String courseID, String semester,int capa ,String userid )
		{
			...
			File f3 = new File("G:/DEEP/Ass2/src/"+path+"/"+userid+".txt");
			if( o==0)
			{
...
//-------------------------------------------------------------------------------------------------------------------------------------------	
	...
	*/
	...
	//	System.out.println(studentID+courseID+courseID);
		...
		else if(chk==2)
		{
			...
			System.out.println(studentID+"is successfully enrolled in "+ courseID);
		...
		else if(chk==3)
		{
			...
			System.out.println("no space available in this subject in this term");
		...
		//return studentID+" cant enroll "+courseID+" in" + semester+" term";
			System.out.println( "Max course capacity exceed for ");
 ...
 class sendMessage implements Runnable {
	    ...
	    File f0 = new File("G:/DEEP/Ass2/src/comp/Server1.txt");
...
public class Server1 {
	...
	public static ImpInterFace impl1;
	...
	public synchronized String enrolCourseserver(String studentID, String courseID, String semester) {
		// TODO Auto-generated method stub
	...
	public synchronized String dropCourseserver(String studentID, String courseID) {
		// TODO Auto-generated method stub
...
public synchronized String addCourseserver(String courseID, String semester,int capa ,String userid ) {
...
public synchronized String removeCourseserver(String courseID, String semester ) {
...
public synchronized String swapCourse1(String studentID,String newCourseID,String oldCourseID)
{
	...
	public static void main(String args[]) {
		...
		impl1 = new ImpInterFace();
		Endpoint endpoint = Endpoint.publish("http://localhost:8080/comp", impl1);
