   ...
   class sendMessage1 implements Runnable {
	   ...
	   Thread t2;
	    ...
	    public static final DateFormat sdfs1 = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
		 File f0 = new File("G:/DEEP/Ass2/src/soen/Server2.txt");
...
public class Server2 {
	...
	public static ImpInterFace impl2;
...
String list="";
	...
	public synchronized String enrolCourseserver1(String studentID, String courseID, String semester) {
		// TODO Auto-generated method stub
	...
	public synchronized String dropCourseserver1(String studentID, String courseID) {
		// TODO Auto-generated method stub
...
public synchronized String swapCourse2(String studentID,String newCourseID,String oldCourseID)
{
		...
		server2methods s2 = new server2methods();
		 receive1 R1 = new receive1();
	      R1.start();
			...
			impl2 = new ImpInterFace();
			Endpoint endpoint = Endpoint.publish("http://localhost:8081/soen", impl2);
